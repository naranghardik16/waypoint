...
import { Bot, Eye, Globe, Mail, MousePointerClick, ScanSearch, Zap, type LucideIcon } from "lucide-react"
...
export const nodeRegistry = {
    ...
    fields: [
      {
        key: "instruction",
        label: "Instruction",
        placeholder: "Extract the listed prices and titles",
        multiline: true,
        required: true,
      },
    ],
    ...
    fields: [
      {
        key: "instruction",
        label: "Instruction",
        placeholder: "Find the cheapest flight to Tokyo and add it to the cart",
        multiline: true,
        required: true,
      },
    ],
  ...
  "send-email": {
    ...
    fields: [
      ...
      { key: "subject", label: "Subject", placeholder: "Your order has shipped", required: true },
      {
        key: "body",
        label: "Body",
